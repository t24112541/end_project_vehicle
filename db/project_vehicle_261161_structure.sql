...
CREATE TABLE `pk_img` (
  ...
  `img_img` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `u_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `pk_missing` (
  ...
  `ms_u_id` int(20) NOT NULL,
  `ms_u_table` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `u_id` int(20) NOT NULL,
  `ms_table` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `ms_date` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `u_ms_date` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `ms_status` text COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`ms_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
